...
% We have a problem with TeXLive using setspace@singlespace but not defining it
% Robin Fairbairns has made a working version at
%   http://www.cl.cam.ac.uk/~rf10/footmisc/footmisc.sty (.pdf)
% Here is a simple patch for now...
\makeatletter
\ifx\setspace@singlespace\@undefined
  \xdef\setspace@singlespace{\baselinestretch}
\fi
\makeatother
...
\boxed{A natural bid of a suit previously mentioned by either partner, or
  \NT, is a \emph{limit bid}.}
...
passing and waiting for a chance to respond.  If the \H3 were a \C3 instead,
we would certainly rather wait than open a 3-card suit with so weak a hand.

\example{AQJT86|K874|T32|---}
...
\example{52|K753|QT2|QT85 Partner opened 1\D}
...
\example{K82|K43|AK4|T975 Partner opened 1\C}
...
\example{AQT87|K4|QJ5|QT3 Partner has opened 1\C, 1\D, or 1\H}
...
\example{T|9642|QJ52|9532 Partner made any opening}
