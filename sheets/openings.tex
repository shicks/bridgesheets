...
In third seat, open light if (high card points + length of two longest suits) \ge\ 20.

\section*{4th seat: Rule of fifteen}
In fourth seat, open light if (high card points + length of spades) \ge\ 15.
