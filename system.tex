...
\begin{tabular}{ll}
  ...
  \nojump\y\force & great hand, hope for game, \approx6-cd strong\\
    & \to raise w/ K-X or three small trump\\
    & \to rebid own suit otherwise\\
...
\begin{tabular}{ll}
  ...
  \unbid{\nojump2\H}\force\force & \textbf{2/1}: 5 \H's, force 2 rounds (10\+p)\\
\end{tabular}
...
\bullet{This does not apply to 1\NT openings}
\subsection{After RHO opens suit 1\x}
\begin{tabular}{ll}
...
\crunch
\subsection{Responses to unusual 2NT}
bid one of partner's two suits.\\
jump with good distribution and a couple honors.\\
may pass only after a \DBL\ with no suit preference.
